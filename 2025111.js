var rid='19190c0956bx5e0265d7x-wpfawj';
$("style:eq(0)").append(`#d2 .roomh[onclick="ujoin('${غيهَبّ}')"]{
background-size: 220% auto;border-radius:  10px 0 10px!important;border: 1px solid #0000;
}`);
$("style:eq(0)").append(`#upro .roomh[onclick="rjoin('${غيهَبّ}')"]{
background-image: url(https://up6.cc/2023/08/16914523717543.png); background-size: cover;color: #666666;
}`);


$(`<style>
.nosel.d-flex.uzr.uid19190c0956bx5e0265d7x-wpfawj .fitimg.u-pic.borderg {
  letter-spacing: 1px;
  background-size: 108% 108%;
  -webkit-text-fill-color: white;
  animation: grad 2s cubic-bezier(.445,.05,.55,.95) alternate infinite;
}
.nosel.d-flex.uzr.uid19190c0956bx5e0265d7x-wpfawj .corner.fa.fa-user.label.uc.fa-microphone.label-danger {
  letter-spacing: 1px;
...
.nosel.d-flex.uzr.uid19190c0956bx5e0265d7x-wpfawj.bord {border-inline: 0px solid #4c121e !important;}
...
.nosel.d-flex.uzr.uid19190c0956bx5e0265d7x-wpfawj {
    background-image: url(https://up6.cc/2024/08/172471730073761.png);
...
.nosel.d-flex.uzr.uid19190c0956bx5e0265d7x-wpfawj .u-topic.dots {
...
#d2.l7dah1 .label-primary{background-color:#b77c9a!important}#d2.l7dah1 .bg{background-color:#b77c9a!important}#d2.l7dah1 .uzr.d-flex.mm.hmsg{border-radius: 10px 0 10px;background-color: #3426231f!important;}#dpnl.l7dah1{background-size: 100%;background-image: url(https://up6.cc/2023/08/169145237174042.png);background-color: #b2b2b2;  }#dpnl.l7dah1 .light{background-color:#ecdce4!important;background-image:linear-gradient(225deg,#dfdfdf 0%,#f7f7f7 29%,#f4f4f4 67%,#dbdbdb 100%);}#d0.l7dah1 .nosel.fl.bg.{background-color:#b77c9a!important;  }#users.l7dah1 span.uhash{text-transform:uppercase;background-image:linear-gradient(-225deg,#7b7b7b 0,#737373 29%,#ebebeb 67%,#3600ff 100%);background-size:220% auto;-webkit-background-clip:text;-webkit-text-fill-color:transparent;animation:2s linear infinite textclip;display:inline-block}
...
#d0.l7dah1 .label-primary {
    ...
    border-radius: 10px 0 10px!important;
    background-image: url(https://up6.cc/2023/08/16914523717543.png);
    color: #ffffff;
    background-size: 100%;
}
...
#uzr.l7dah1 .tablebox.d-flex.footer.fl.light {
    border-radius:  10px 0 10px!important;
    border: 1px solid #ecdce4;
    background-color: #52443e;
}
#upro.l7dah1 .light.fl.pro.break {
    ...
    background-image: url(https://up6.cc/2023/08/169145237176584.png);
    background-size: 100%;
}
#mic.l7dah1 #muteall {
    border-radius: 10px 0 10px;
...
#uzrs.l7dah1 .fitimg.u-pic.borderg{
height: 52px !important;
border: 1px solid;
...
button.usave.btn.btn-primary.fl.l7dah1 {
   background-image: url(https://up6.cc/2023/08/169145237174042.png);
   background-size: cover;
   border-radius: 10px 0 10px;
}
...
setInterval(function () {
    if (myuzr == '19190c0956bx5e0265d7x-wpfawj') {
        if (l7dah == false) {
            l7dah = true;
                $('#d0, #users, #d2, #mic, #settings, #uzrs, #uzrs, #d0, #chats, #d2bc, #muteall, #wall, #dpnl, #upro').addClass('l7dah1');
		...
		$('input, button.usave.btn.btn-primary.fl, button.border.btn.label.label-success.fl.fa.fa-plus, button.blike.corner.btn.minix.btn-danger.fa.fa-heart, .fl.borderg, .fl.u-pic.fitimg, .dots, .tc, .label.fl.label-primary, .btn.btn-primary.u-nickc.fr.fa.fa-save, .modal-header.label-primary, .corner.border.label.label-primary, .head.d-flex.nosel.bg.fl, .usave.btn.btn-primary.fr, .fa.fa-send.sndpm.fl.btn.btn-primary, .fr.fa.fa-share-alt.sndfile.fl.btn.btn-primary, .fr.fa.fa-share-alt.sndfilebc.fl.btn.btn-primary, .bdel.corner.btn.minix.btn-primary.fa.fa-times, .fa.fa-send.sndbc.fl.btn.btn-primary').removeClass('l7dah1');
            } 
        } 
    }, 10);
